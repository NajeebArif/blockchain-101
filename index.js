...
function calculateHashWithNonce(nonce) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            data = 'Hello World' + nonce;
            return [2 /*return*/, generateHash(data)];
        });
    });
}
function mine() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, calculateHashWithNonce(++nonce)];
                case 1:
                    hash = _a.sent();
                    _a.label = 2;
                case 2:
                    if (hash.startsWith('0000') === false) return [3 /*break*/, 0];
                    _a.label = 3;
                case 3:
